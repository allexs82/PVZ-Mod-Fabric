...
public class SnowPeashooterRenderer extends GeoEntityRenderer<SnowPeashooterEntity> {
    public SnowPeashooterRenderer(EntityRendererFactory.Context renderManager) {
        super(renderManager, new DefaultedEntityGeoModel<>(ModCore.id("plants/snow_peashooter"), true));
    }
}
